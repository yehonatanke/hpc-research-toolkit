...
#SBATCH --output=/leonardo_work/AIFAC_S02_060/data/yk/debug/output/viz_data/viz_data_interactive_3D/%j/job.out
#SBATCH --error=/leonardo_work/AIFAC_S02_060/data/yk/debug/output/viz_data/viz_data_interactive_3D/%j/job.err
