...
#SBATCH --job-name=debug_resize
#SBATCH --output=/leonardo_work/AIFAC_S02_060/data/yk/code/scripts/logs/da3/debug_resize/%j.out.log
#SBATCH --error=/leonardo_work/AIFAC_S02_060/data/yk/code/scripts/logs/da3/debug_resize/%j.err.log
...
# general
TASK_NAME="debug_resize"
DESCRIPTION="Debug resize [Depth Anything 3]"

# job paths
# scene path:
SCENE_PATH="${WORK}/data/re10k_precessed/test/test/images/0a3b5fb184936a83" 

OUTPUT_DIR="${DEBUG}/output/da3/debug_resize" 
...
# logs
LOG_DIR="${CODE}/scripts/logs/da3/debug_resize"
...
# main message
GENERAL_VARS=(DESCRIPTION SCENE_PATH OUTPUT_DIR MODEL_DIR DEPTH_ANYTHING_DIR LOG_DIR VENV)
