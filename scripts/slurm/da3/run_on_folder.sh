...
#SBATCH --job-name=create_da3_dummy_dataset_conf_thresh_30
#SBATCH --output=/leonardo_work/AIFAC_S02_060/data/yk/debug/logs/da3/create_dummy_dataset/dif_confs/40/%j.out.log
#SBATCH --error=/leonardo_work/AIFAC_S02_060/data/yk/debug/logs/da3/create_dummy_dataset/dif_contrast/40/%j.err.log
...
LOG_DIR="${DEBUG}/logs/da3/create_dummy_dataset/dif_confs"
