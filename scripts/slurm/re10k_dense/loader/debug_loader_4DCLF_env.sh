...
#SBATCH --job-name=debug_loader_for_re10k_4DCLF_env
#SBATCH --output=/leonardo_work/AIFAC_S02_060/data/yk/code/scripts/logs/re10k_dense/debug_loader/4DCLF_env/%j.out.log
#SBATCH --error=/leonardo_work/AIFAC_S02_060/data/yk/code/scripts/logs/re10k_dense/debug_loader/4DCLF_env/%j.err.log
...
# general
TASK_NAME="debug loader for re10k 4DCLF env"
DESCRIPTION="Debug loader for re10k 4DCLF env"
...
# logs
LOG_DIR=${CODE}/scripts/logs/re10k_dense/debug_loader/4DCLF_env
